...
const disableSubmit = ref(true); //처음에 비활성화(눌러도 반응 없음) → 중복체크한 후, 활성화됨 (disableSubmit=false가 되어야 활성화됨)
...
// join함수 - 사용자가 입력한 정보를 바탕으로 최종가입시도. => 성공시 페이지를 이동.
const join = async () => {
...
<template>
  <div class="mt-5 mx-auto" style="width: 500px">
    ...
    <!-- form내 submit버튼을 눌러 바로전송하는 기능을막고, join함수호출. -->
